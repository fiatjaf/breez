...
replace (
	...
	github.com/lightninglabs/neutrino => github.com/breez/neutrino v0.11.1-0.20200608093930-695c8f6c62f0
	github.com/lightningnetwork/lnd v0.9.2-beta => github.com/breez/lnd v0.9.2-beta.0.20200705150037-4e113a227118
